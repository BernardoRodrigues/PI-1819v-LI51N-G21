module.exports = function() {
    ...
    const Image = require('./model/image-dto-model').default
    const Artist = require('./model/artist-dto-model').default
    const Album = require('./model/album-dto-model').default
    const AlbumInfo = require('./model/album-info-dto-model').default
    ...
    function mapArtists(result) {
        ...
        return JSON.parse(result).results.artistmatches.artist.map(a => 
