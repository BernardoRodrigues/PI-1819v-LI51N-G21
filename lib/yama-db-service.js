module.exports = function (elasticSearchService) {
    ...
    async function createPlaylist(playlistDto) {
        ...
        return await elasticSearchService.createPlaylist(playlist)
    }
    ...
    async function deletePlaylist(playlistDto) {
        ...
        const playlist = mapPlaylistToPlaylistDto(playlistDto)
        return await elasticSearchService.deletePlaylist(playlist)
    }
    ...
    async function updatePlaylist(playlistDto) {
        ...
        const playlist = mapPlaylistToPlaylistDto(playlistDto)
        return await elasticSearchService.updatePlaylist(playlist)
    }

    async function getPlaylists() {
        return await elasticSearchService.getPlaylists()
    }
    ...
    async function getPlaylistInfo(playlistDto) {
        ...
        const playlist = mapPlaylistToPlaylistDto(playlistDto)
        return await elasticSearchService.getPlaylistInfo(playlist)
    }
    ...
    async function addMusicToPlaylist(playlistDto) {
        ...
        const playlist = mapPlaylistToPlaylistDto(playlistDto)
        return await elasticSearchService.addMusicToPlaylist(playlist)
    }
    ...
    async function removeMusicFromPlaylist(playlistDto) {
        ...
        const playlist = mapPlaylistToPlaylistDto(playlistDto)
        return await elasticSearchService.removeMusicFromPlaylist(playlist)
    }
